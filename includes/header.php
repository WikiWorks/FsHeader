	...
	<div class="top">
			...
			<nav id="primaryNav">
				...
				<div class="primary-nav-item nav-menu-parent ">
					...
					<ul class="submenu" aria-hidden="true" data-submenu="" aria-label="Submenu">
						...
						<li class="submenu-item">
							<a href="/search/tree/name" class="submenu-link" data-config="lo_hdr9_srch:findInFamilyTree" data-test="findInFamilyTree" data-component-init="AdobeLinkTracker"><?php $t ('header-familytree');?></a>
						</li>
						<li class="submenu-item">
						...
						<li class="submenu-item">
							<a href="/en/wiki/Main_Page" class="submenu-link" data-config="lo_hdr9_srch:wiki" data-test="wiki" data-component-init="AdobeLinkTracker"><?php $t ('header-researchwiki');?></a>
						</li>
					</ul>
				</div>
		...
		<div class="right">
			<nav id="secondaryNav">
				...
				<a class="highlight" id="signinLink" href="/<?php $t ('header-language');?>/wiki/Special:UserLogin?returnto=<?php echo ( preg_replace (['%^/(de|en|es|fr|it|ja|ko|pt|ru|sv|zh)/wiki/%', '%\?.*$%'], '', $_SERVER['REQUEST_URI']) );?>"><?php $t ('header-signin');?></a>
				...
				<a id="logoutLink" style="display:none; float:left;" class="highlight" href="/<?php $t ('header-language');?>/wiki/Special:UserLogout?returnto=<?php echo ( preg_replace (['%^/(de|en|es|fr|it|ja|ko|pt|ru|sv|zh)/wiki/%', '%\?.*$%' ], '', $_SERVER['REQUEST_URI']) );?>" class="user-submenu-link" data-test="NavigationLogOut" data-component="AdobeLinkTracker" data-config="{&quot;type&quot;: &quot;o&quot;, &quot;name&quot;: &quot;li_hdr_signout&quot;}"><?php $t ('header-signout');?></a>
